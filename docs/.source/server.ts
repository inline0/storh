...
import * as __fd_glob_11 from "../content/docs/jsonc.mdx?collection=docs"
import * as __fd_glob_10 from "../content/docs/install.mdx?collection=docs"
import * as __fd_glob_9 from "../content/docs/indexes.mdx?collection=docs"
import * as __fd_glob_8 from "../content/docs/index.mdx?collection=docs"
import * as __fd_glob_7 from "../content/docs/engines.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, }, {"api.mdx": __fd_glob_1, "atomicity.mdx": __fd_glob_2, "benchmarks.mdx": __fd_glob_3, "bulk-data.mdx": __fd_glob_4, "caching.mdx": __fd_glob_5, "cli.mdx": __fd_glob_6, "engines.mdx": __fd_glob_7, "index.mdx": __fd_glob_8, "indexes.mdx": __fd_glob_9, "install.mdx": __fd_glob_10, "jsonc.mdx": __fd_glob_11, "queries.mdx": __fd_glob_12, "query-builder.mdx": __fd_glob_13, "quick-start.mdx": __fd_glob_14, "scaling-limits.mdx": __fd_glob_15, "schema.mdx": __fd_glob_16, "sharding.mdx": __fd_glob_17, "sql-mirror.mdx": __fd_glob_18, "uuidv7.mdx": __fd_glob_19, });